...
def sample(training_data_path, count, calibration_path):
    files = os.listdir(training_data_path)
    random.shuffle(files)
    for f in files[:count]:
        shutil.copyfile(training_data_path + f, calibration_path + f)


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--training_data_path', type=str, default=None, help='traing data path')
